For the first 5 files originally they didn't have the specified rule and examples in the code fragments so I had to reupload the noncompliant and fixed compliant solution for each one.
